...
export default function Post(props) {
  ...
  const meta = {
    ...
    ogUrl: `https://${data.site.subdomain}.ryanhmaas.xyz/${data.slug}`,
    ogImage: data.image,
    logo: "/logo.png",
  };
...
async function getMdxSource(postContents) {
  ...
  const processedContent = await remark()
    ...
    .use(() => replaceExamples(prisma)) // replaces examples with <Example /> component (only for demo.ryanhmaas.xyz)
